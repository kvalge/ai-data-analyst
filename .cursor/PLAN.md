...
**6.3 done.** Next: **6.4 Bind RAG tool to the graph**.
Do not start 6.4 until you say to proceed.
Context chunks can be queried with TF-IDF. Not a graph tool yet.
