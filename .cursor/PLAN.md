...
**6.4 done.** Next: **6.5 Reindex on context upload**.
Do not start 6.5 until you say to proceed.
The agent can retrieve domain-context snippets. The index is rebuilt on each call.
